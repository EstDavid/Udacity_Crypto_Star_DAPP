...
const contractAddress = '0xE7CB5f085C3f397cB0b525702B7E4AabF330CEc8';
const App = {
  web3: null,
  account: null,
  meta: null,
  ...
  lookUp: async function (){
    ...
    if (starName) {
      App.setStatus("The name of the Star ID " + lookId + " is " + starName + ".");
    }
    else {
      App.setStatus("Star ID " + lookId + " doesn't exist.");
    }
